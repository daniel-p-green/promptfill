...
- [`skills/remotion-motion-director/SKILL.md`](skills/remotion-motion-director/SKILL.md) for storyboard quality, cinematic pacing, and iterative critique loops.
- `remotion-best-practices` for technical correctness (timing, transitions, GIF handling, composition patterns, captions, and rendering).
